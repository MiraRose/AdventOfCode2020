...
test('given passport without all fields, returns false', () => {

    var string = "iyr:2013 ecl:amb cid:350 eyr:2023 pid:028048884\n" +
    "hcl:#cfa07d byr:1929"
...
test('given passport blob, returns correct num of valid passports', () => {
    ...
    result = day4.findNumberOfValidPassports(string);
